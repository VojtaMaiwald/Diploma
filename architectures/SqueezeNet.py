...
class SqueezeNet:
    def __init__(self, input_shape, n_classes):
        ...
        self.model.add(tf.keras.layers.Conv2D(64, (3, 3), activation='relu', padding='same', input_shape=input_shape))
        ...
        self.model.add(tf.keras.layers.Conv2D(512, (3, 3), activation='relu', padding='same'))
        self.model.add(tf.keras.layers.MaxPooling2D((2, 2), strides=(2, 2)))
