...
for name in glob.glob(".\\nets\\EfficientNet\\EfficientNetB0_AroVal_E25_B8_SGD0.01_AUGFULL_SHUFFLE"):
	...
	#print(converter.inference_input_type, converter.inference_output_type, converter.target_spec.supported_ops, [i for i in converter.target_spec.supported_types])
