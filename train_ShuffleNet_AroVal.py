...
SHUFFLE = True
LEARNING_RATE = 0.001
CHANNELS = 400 # must be divisible by (4 * num of classes)
DROPOUT = 0.2
ENDING_STRING = ("AUGFULL" if AUGMENT else "") + ("_SHUFFLE" if SHUFFLE else "")
MODEL_NAME = f"ShuffleNet_AroVal_E{EPOCHS}_B{BATCH_SIZE}_Channels{CHANNELS}_Adam{LEARNING_RATE}_{ENDING_STRING}"
