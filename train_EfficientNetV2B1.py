...
MODEL_NAME = f"EfficientNetV2B1_E{EPOCHS}_B{BATCH_SIZE // 3}_SGD{LEARNING_RATE}_{ENDING_STRING}"
...
#def load_model(existingModelPath = None):
	if existingModelPath != None:
		...
		with strategy.scope():
			model = EfficientNetV2B1(classes = 8, weights = None, input_shape = IMAGE_SHAPE)
